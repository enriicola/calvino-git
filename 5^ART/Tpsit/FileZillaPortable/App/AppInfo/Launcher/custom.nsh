...
${Segment.onInit}
	${IfNot} ${FileExists} "$EXEDIR\App\FileZilla\fzdefaults.xml"
		MessageBox MB_ICONEXCLAMATION "A file missing for proper portablization is missing. File ($EXEDIR\App\FileZilla\fzdefaults.xml) is not present.  Please reinstall the app before running."
		Abort
	${EndIf}
!macroend
